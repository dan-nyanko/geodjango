...
This tutorial will go over how to setup Macintosh OSX (10.11.16) for developing [GeoDjango](https://docs.djangoproject.com/en/dev/ref/contrib/gis/tutorial/) web application.
